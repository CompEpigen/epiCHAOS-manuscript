...
#--- test the effect of sequencing depth on raw and sparsity-adjusted epiCHAOS score using simulated data with varying sequencing depth generated by scReadSim

library(epiCHAOS)
library(dplyr)
library(stringr)

#--- simulated data were generated in scReadSim in python using the following command where total_count_new was varied from 50000 to 100000
# GenerateSyntheticCount.scATAC_GenerateSyntheticCount(count_mat_filename=count_mat_peak_filename, directory=outdirectory, outdirectory=outdirectory, total_count_new=100000, n_cell_new=500)
